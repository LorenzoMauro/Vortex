...
namespace vtx::graph
{
	...
	{
		return { transform, envTexture};
	}

	void EnvironmentLight::accept(NodeVisitor& visitor)
	{
		visitor.visit(as<EnvironmentLight>());
	}

	void EnvironmentLight::computeSphericalCdf()
	{
	...
	void EnvironmentLight::computeCdfAliasMaps()
	{
